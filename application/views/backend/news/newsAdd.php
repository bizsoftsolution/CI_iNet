   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			<div class="col-md-6">
				<h3 class="panel-title">Add New News
			</h3>
			</div>
			<div class="col-md-6">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <div class="alert alert-success">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Success !!! </strong> New News Created successfully
               </div>
               <?php } ?>
			</div>   
	<div class="col-md-12">
		<form class="form-horizontal form-validate-jquery" action="<?php echo  base_url();?>News/newsAdd" method="POST" enctype="multipart/form-data">
			<div class="col-md-12">
				<div class="panel panel-flat">
									...
									<label class="control-label col-md-3"><b>Youtube URL</b> <strong style="color:red;">*</strong></label>
										<div class="col-md-9">
											<div class="field_wrapper">
												...
												<div class="col-sm-2">
													 <a href="javascript:void(0);" class="add_button" title="Add field" style="float:right;    margin: 9px 30px;border: 1px solid #c5c5c5;padding: 5px;background: #f1f1f1;border-radius: 4px;box-shadow: 1px 1px 3px;">
